package com.lvfeng.tool.chars.encrypt;
 ...
 * @author LvFeng
 * 实现加密解密的工具类
 * 加密手段：DES 一种56位密钥的对称算法
 * 借助apache Lang3 maven需要导入依赖
 * SOURCE：https://blog.csdn.net/shuai825644975/article/details/71730535
 * 应用：实现在对api接口key字符串的加密，只保留一个private key即可完成转换
 */
