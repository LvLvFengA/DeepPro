...
class SimpleCalendar {
  ...
  create() {
    ...
    //actions
    header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '      <div class="sc-yleft">' + '        <span class="layui-btn layui-btn-xs">《&nbsp;</span></div>' + '      <select class="sc-select-year" name="">' + '      </select>' + '      <div class="sc-yright"><span class="layui-btn layui-btn-xs">&nbsp;》</span></div>' + '  </div>';
    header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '    <div class="sc-mleft">' + '      <span class="layui-btn layui-btn-xs">《&nbsp;</span></div>' + '    <select class="sc-select-month" name="">' + '    </select>' + '    <div class="sc-mright"><span class="layui-btn layui-btn-xs">&nbsp;》</span></div>' + '</div>';
    header.innerHTML = header.innerHTML + '<div class="sc-actions"><span class="sc-return-today"><button class="layui-btn layui-btn-warm layui-btn-xs">返回今天</button></span></div>';
